...
<div class="col-sm-9 form-group"><input type="password" class="form-control validate[required,minSize[6]] text-input login-field  login-field-password" id="password-3" name="password">
